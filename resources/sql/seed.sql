...
insert into "membership"(user_id, group_id, moderator) values(2,4, true);
insert into "membership"(user_id, group_id) values(5,4);
...
insert into "user_content"(id, "text", creator_id, group_id, priv_stat) values(21, 'Yes! It is called the Sudanese Mobius Band.', 8, null, 'Private');
insert into "user_content"(id, "text", creator_id, group_id, priv_stat) values(22, 'Dudley is my favorite character', 4, 3, 'Public');
insert into "user_content"(id, "text", creator_id, group_id, priv_stat) values(23, 'You cannot hear pictures', 6, null, 'Private');
insert into "user_content"(id, "text", creator_id, group_id, priv_stat) values(24, 'The NBA season ends on April 10th', 7, null, 'Private');
insert into "user_content"(id, "text", creator_id, group_id, priv_stat) values(25, 'My Dog ate all my games yesterday', 10, null, 'Private');
insert into "user_content"(id, "text", creator_id, group_id, priv_stat) values(14, 'A Big Mac does not cost 3.99$, is costs your health. Netflix does not cost 17.99$, is costs your time. Social media is not free, it costs your focus. There is always a hidden cost.', 5, null, 'Private');
