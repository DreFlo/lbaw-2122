...
class PostPolicy
{
    ...
    {
        return $user->id === $post->content()->creator_id;
    }
    ...
    {
        return $user->id === $post->content()->creator_id || $user->isAdmin();
    }
    ...
    {
        return ($user->isAdmin() && $post->content()->priv_stat === 'Banned') ||
            ($user->id === $post->content()->creator_id && $post->content()->priv_stat === 'Anonymous');
    }
